...
def run_test(self, location, num_steps, expected_series, *,
    ...
    diagram.trigger_subsystem_add_line_name()
...
class SimTest(unittest.TestCase):
    ...
    def testSldemoCounters(self):
        run_test(self,"./Examples/Simulink/sldemo_counters_2018a.xml",100,{},
                 output_to_file="./Examples/Simulink/sldemo_counters_2018a.txt")
