...
class SFConvertTest(unittest.TestCase):
    ...
    def testCommunication1(self):
        ...
        run_test(self, prefix+"Data/Communication1.xml", 62,
            ['log en_A', 'log en_A1', 'log en_B', 'log 1 1', 'delay 0.1',
             'log en_A', 'log 2 2', 'delay 0.1', 'log en_B', 'log 2 2', 'delay 0.1',
             'log en_A', 'log 3 3', 'delay 0.1', 'log en_B', 'log 3 3', 'delay 0.1',
    ...
    def testCommunication2(self):
        ...
        run_test(self, prefix+"Data/Communication2.xml", 65,
            ['log en_A', 'log en_A1', 'log en_B', 'log 1 2 1 1', 'delay 0.1',
             ...
             'log en_B', 'log 1 2 2 2', 'delay 0.1',
             'log en_A', 'log 1 2 3 3', 'delay 0.1',
             'log en_B', 'log 1 2 3 3', 'delay 0.1'], io_filter=io_filter,
    ...
    def testCommunication4(self):
        ...
        run_test(self, prefix+"Data/Communication4.xml", 105,
            ['log en_A', 'log en_A1', 'log en_B', 'log 2 2', 'delay 0.1',
             'log en_A', 'log 4 4', 'delay 0.1', 'log en_B', 'log 4 4', 'delay 0.1',
             'log en_A', 'log 6 6', 'delay 0.1', 'log en_B', 'log 6 6', 'delay 0.1',
             'log en_A', 'log 8 8', 'delay 0.1'], io_filter=io_filter,
            output_to_file=prefix+"Data/Communication4.txt")

    def testCommunication5(self):
        io_filter = lambda s: False
        run_test(self, prefix+"Data/Communication5.xml", 147,
           ['log en_A', 'log en_C', 'log en_A1', 'log en_B', 'log 1 2 2', 'delay 0.1',
            'log en_A', 'log 2 4 4', 'delay 0.1', 'log en_B', 'log 2 4 10', 'delay 0.1',
            'log en_A', 'log 3 6 20', 'delay 0.1', 'log en_B', 'log 3 6 42', 'delay 0.1',
    ...
    def testCommunication6(self):
        ...
        run_test(self, prefix+"Data/Communication6.xml", 120,
            ['log en_A', 'log en_A1', 'log en_C', 'log en_B', 'log 1 1', 'log 1', 'delay 0.1',
             'log en_A', 'log 2 2', 'log 1', 'delay 0.1',
             'log en_B', 'log 2 2', 'log 2', 'delay 0.1',
             'log en_A', 'log 3 3', 'log 2', 'delay 0.1',
             'log en_B', 'log 3 3', 'log 3', 'delay 0.1',
