...
def is_add(e: Expr) -> TypeGuard[OpExpr]:
    return isinstance(e, OpExpr) and e.op == "+"

def is_mul(e: Expr) -> TypeGuard[OpExpr]:
    return isinstance(e, OpExpr) and e.op == "*"
...
def is_conj(e: Expr) -> TypeGuard[LogicExpr]:
...
def is_disj(e: Expr) -> TypeGuard[LogicExpr]:
    return isinstance(e, LogicExpr) and e.op == "||"
...
def is_imp(e: Expr) -> TypeGuard[LogicExpr]:
    return isinstance(e, LogicExpr) and e.op == "->"
...
def is_eq(e: Expr) -> TypeGuard[RelExpr]:
    return isinstance(e, RelExpr) and e.op == "=="

def eq(e1: Expr, e2: Expr) -> RelExpr:
