...
from ss2hcsp.Reinforcement_learning.random_map.DQN import DeepQNetwork, DeepQNetworkExternal
import random
import copy
...
class ISR_Test(unittest.TestCase):
    ...
    def test_ISRdqn(self):
        with open("ss2hcsp/Reinforcement_learning/random_map/ISR_DQN.txt", "r") as f:
            text = f.read()
