...
from ss2hcsp.sysml_sm.sm_state import AND_State, OR_State


class SM_Chart():
    def __init__(self, name, state, data, num_src, num_dest, st):
        #super(SM_Chart, self).__init__(name, num_src, num_dest, None)
        ...
        assert isinstance(state, (AND_State, OR_State))#print state_type
        self.diagram = state
