...
\<comment> \<open>The file firstly defines the constraints and executions for discrete diagrams, then
proof the existence and uniqueness for discrete diagrams\<close>
...
section \<open>definitions and theorems for execution\<close>
